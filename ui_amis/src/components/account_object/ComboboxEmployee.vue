  ...
  <div class="m-combobox">
    ...
    <div class="m-combobox__body">
      <input
        ...
        @input="clickout"
      />
      <div class="btn-dropdown" style="right: 33px">
        <div
      ...
      <div v-if="isShow" class="m-combobox__menu">
        <div class="menu-header">
          <div class="menu-header__th" style="width: 50p%">Mã nhân viên</div>
          <div class="menu-header__th" style="flex: 1">Tên nhân viên</div>
        </div>
        <div class="menu-body">
          <table>
            <tbody>
              <tr
                ...
                @click="updateValueAndText(department.departmentId, $event)"
              >
