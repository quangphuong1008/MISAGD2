<template>
  <div class="m-text-field">
    ...
    <input type="text" :value="value" @input="updateValue($event.target.value)" :class="{'m-input-error': checkInput}" :title="(checkInput) ? errorText: null" :placeholder='[[ placeholder ]]'
    :style="{ height: height }"
    />
  </div>
</template>
